...
void main() {
  ...
  testWidgets('Artifact 01: Fresh Install Login Screen', (WidgetTester tester) async {
    tester.view.physicalSize = const Size(1170, 2532);
    tester.view.devicePixelRatio = 3.0;
    addTearDown(tester.view.resetPhysicalSize);
    addTearDown(tester.view.resetDevicePixelRatio);

    await tester.pumpWidget(wrapScreen(const LoginScreen()));
    await tester.pump(const Duration(milliseconds: 150));
    await captureScreen(tester, '$brainDir/01_fresh_install_login_screen.png');
    await tester.pumpWidget(const SizedBox());
    await tester.pump(const Duration(milliseconds: 100));
  });

  testWidgets('Artifact 02: User A Login Home Screen', (WidgetTester tester) async {
    tester.view.physicalSize = const Size(1170, 2532);
    tester.view.devicePixelRatio = 3.0;
    addTearDown(tester.view.resetPhysicalSize);
    addTearDown(tester.view.resetDevicePixelRatio);
    ...
    await tester.pump(const Duration(milliseconds: 150));
    await captureScreen(tester, '$brainDir/02_user_a_home_screen.png');
  });

  testWidgets('Artifact 03: User A Persisted After Force-Quit', (WidgetTester tester) async {
    tester.view.physicalSize = const Size(1170, 2532);
    tester.view.devicePixelRatio = 3.0;
    addTearDown(tester.view.resetPhysicalSize);
    addTearDown(tester.view.resetDevicePixelRatio);
    ...
    await tester.pump(const Duration(milliseconds: 150));
    await captureScreen(tester, '$brainDir/03_user_a_persisted_after_force_quit.png');
  });
  ...
  testWidgets('Artifact 04: User B Login Home Screen', (WidgetTester tester) async {
    ...
    await tester.pump(const Duration(milliseconds: 150));
    await captureScreen(tester, '$brainDir/04_user_b_home_screen.png');
  });

  testWidgets('Artifact 05: User B Persisted After Force-Quit', (WidgetTester tester) async {
    tester.view.physicalSize = const Size(1170, 2532);
    tester.view.devicePixelRatio = 3.0;
    addTearDown(tester.view.resetPhysicalSize);
    addTearDown(tester.view.resetDevicePixelRatio);
    ...
    await tester.pump(const Duration(milliseconds: 150));
    await captureScreen(tester, '$brainDir/05_user_b_persisted_after_force_quit.png');
  });

  testWidgets('Artifact 06: Maintenance Garbage Input Rejection', (WidgetTester tester) async {
    tester.view.physicalSize = const Size(1170, 2532);
    tester.view.devicePixelRatio = 3.0;
    addTearDown(tester.view.resetPhysicalSize);
    addTearDown(tester.view.resetDevicePixelRatio);
    ...
    // Tap submit to trigger validation error borders and messages
    await tester.tap(find.text('FILE SERVICE REQUEST'));
    await tester.pump(const Duration(milliseconds: 150));

    await captureScreen(tester, '$brainDir/06_maintenance_garbage_rejection.png');
  });

  testWidgets('Artifact 07: Admin Maintenance & Deposit Hub Trace', (WidgetTester tester) async {
    tester.view.physicalSize = const Size(1170, 2532);
    tester.view.devicePixelRatio = 3.0;
    addTearDown(tester.view.resetPhysicalSize);
    addTearDown(tester.view.resetDevicePixelRatio);
    ...
    await captureScreen(tester, '$brainDir/07_maintenance_valid_submission_admin.png');
  });
}
