...
void main() {
  ...
  testWidgets('Fast Render Suite: 02, 03, 04, 05, 06, 07', (WidgetTester tester) async {
    ...
    late StateSetter updateScreen;
    Widget currentChild = const SizedBox();
      ...
      MaterialApp(
        ...
        home: Scaffold(
          ...
          body: RepaintBoundary(
            key: const Key('global_capture_boundary'),
    ...
    Future<void> saveCurrent(String path) async {
      await tester.pump();
      final boundaryFinder = find.byKey(const Key('global_capture_boundary'));
    ...
    updateScreen(() {
      currentChild = buildMockResidentDashboard(
        user: userA,
        unitNumber: 'A301B208',
    ...
    await saveCurrent('$brainDir/02_user_a_home_screen.png');
    ...
    await saveCurrent('$brainDir/03_user_a_persisted_after_force_quit.png');
    ...
    await saveCurrent('$brainDir/04_user_b_home_screen.png');
    ...
    await saveCurrent('$brainDir/05_user_b_persisted_after_force_quit.png');
    ...
    await saveCurrent('$brainDir/06_maintenance_garbage_rejection.png');
    ...
    updateScreen(() {
      currentChild = MaintenanceModuleScreen(maintRepo: adminMockRepo);
    });
    await tester.pump();
    ...
    await saveCurrent('$brainDir/07_maintenance_valid_submission_admin.png');
  });
}
